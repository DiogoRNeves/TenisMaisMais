...
class FederationTournamentHasAgeBand extends CExtendedActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('federationTournamentID, ageBandID', 'required'),
            array('federationTournamentID, ageBandID', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('federationTournamentID, ageBandID', 'safe', 'on' => 'search'),
        );
    }
